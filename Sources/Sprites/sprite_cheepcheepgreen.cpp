...
Sprite_CheepCheepGreen::Sprite_CheepCheepGreen(const Texture& texture, Collider* collision) : Sprite_CheepCheep(texture, collision)
{
}

void Sprite_CheepCheepGreen::secureUpdate()
{
    if (!m_active)
        return;
...
ID Sprite_CheepCheepGreen::getID() const
{
    return ID_USELESS;
}

void Sprite_CheepCheepGreen::draw(RenderTarget& target, RenderStates) const
{
