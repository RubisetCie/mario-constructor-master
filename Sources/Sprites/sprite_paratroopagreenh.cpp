...
Sprite_ParatroopaGreenH::Sprite_ParatroopaGreenH(const Texture& texture, Texture* const turtle_texture, Texture* const shell_texture, Collider* collision, float target) : Sprite_Paratroopa(texture, turtle_texture, shell_texture, collision)
{
    m_target = target + 16;
...
void Sprite_ParatroopaGreenH::setPosition(const Vector2f& pos)
{
    m_startpos = pos.x;
...
void Sprite_ParatroopaGreenH::flyUpdate()
{
...
void Sprite_ParatroopaGreenH::toTurtle()
{
...
ID Sprite_ParatroopaGreenH::getID() const
{
    if (m_state == 0)
        return ID_USELESS;
    else if (m_state >= 2)
...
void Sprite_ParatroopaGreenH::draw(RenderTarget& target, RenderStates) const
{
