...
Sprite_PlantGreyB::Sprite_PlantGreyB(Texture* texture, Collider* collision) : Sprite_PlantB(texture, collision)
{
    m_timer = 340;
}

void Sprite_PlantGreyB::update()
{
    Sprite_PlantB::update();
}

void Sprite_PlantGreyB::secureUpdate()
{
    if (m_timer < 340)
    {
        m_timer++;
...
void Sprite_PlantGreyB::afterUpdate()
{
}

void Sprite_PlantGreyB::draw(RenderTarget& target, RenderStates) const
{
