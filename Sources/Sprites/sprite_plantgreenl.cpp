...
Sprite_PlantGreenL::Sprite_PlantGreenL(Texture* texture, Collider* collision) : Sprite_PlantL(texture, collision)
{
    m_timer = 340;
}

void Sprite_PlantGreenL::update()
{
    if (player != NULL)
    {
...
void Sprite_PlantGreenL::secureUpdate()
{
    if (m_timer < 340)
    {
        m_timer++;
...
void Sprite_PlantGreenL::afterUpdate()
{
}

void Sprite_PlantGreenL::draw(RenderTarget& target, RenderStates) const
{
