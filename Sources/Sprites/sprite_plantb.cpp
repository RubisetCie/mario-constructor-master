...
#include "../../Headers/Sprites/sprite_plantb.hpp"
...
Sprite_PlantB::Sprite_PlantB(Texture* texture, Collider* collision) : Placeable()
{
...
void Sprite_PlantB::setPosition(const Vector2f& pos)
{
...
Vector2f Sprite_PlantB::getPosition() const
{
    return Vector2f(m_aabb.left, m_startheight);
}

Vector2f Sprite_PlantB::getSize() const
{
    return Vector2f(31, 47);
}

ID Sprite_PlantB::getID() const
{
    return ID_USELESS;
}
