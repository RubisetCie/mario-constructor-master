...
Sprite_PlantGreenT::Sprite_PlantGreenT(Texture* texture, Collider* collision) : Sprite_PlantT(texture, collision)
{
    m_timer = 340;
}

void Sprite_PlantGreenT::update()
{
    if (player != NULL)
    {
...
void Sprite_PlantGreenT::secureUpdate()
{
    if (m_timer < 340)
    {
        m_timer++;
...
void Sprite_PlantGreenT::afterUpdate()
{
}

void Sprite_PlantGreenT::draw(RenderTarget& target, RenderStates) const
{
