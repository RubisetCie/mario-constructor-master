...
Hazard_RotodiscRC::Hazard_RotodiscRC(const Texture& texture, const Vector2f& disk_pos, float speed) : Hazard_Rotodisc(texture, disk_pos, speed)
{
...
void Hazard_RotodiscRC::setPosition(const Vector2f& pos)
{
